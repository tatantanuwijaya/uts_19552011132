...
class DetailLavenderPage extends StatefulWidget {
  const DetailLavenderPage({Key? key}) : super(key: key);

  @override
  _DetailLavenderPageState createState() => _DetailLavenderPageState();
}

class _DetailLavenderPageState extends State<DetailLavenderPage> {
  @override
