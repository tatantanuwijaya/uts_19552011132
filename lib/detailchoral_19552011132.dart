...
class DetailChoralPage extends StatefulWidget {
  const DetailChoralPage({ Key? key }) : super(key: key);

  @override
  _DetailChoralPageState createState() => _DetailChoralPageState();
}

class _DetailChoralPageState extends State<DetailChoralPage> {
  @override
