...
class DetailMintPage extends StatefulWidget {
  const DetailMintPage({Key? key}) : super(key: key);

  @override
  _DetailMintPageState createState() => _DetailMintPageState();
}

class _DetailMintPageState extends State<DetailMintPage> {
  @override
        ...
        leading: ButtonBar(
          children: [
            Container(
              ...
              child: IconButton(onPressed: ()=>Navigator.pop(context), icon: Icon(Icons.keyboard_arrow_left, size: 22, color: Color(0xff70b1a1),)),
            ),
          ],
        ),
        title: Center(
