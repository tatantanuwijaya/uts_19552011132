...
class DetailBluePage extends StatefulWidget {
  const DetailBluePage({ Key? key }) : super(key: key);

  @override
  _DetailBluePageState createState() => _DetailBluePageState();
}

class _DetailBluePageState extends State<DetailBluePage> {
  @override
